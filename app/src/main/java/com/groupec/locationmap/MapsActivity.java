package com.groupec.locationmap;
   ...
   private GoogleMap mMap;
    ...
    public void onClick(View v) {
        if(v == buttonSave){
            ...
            getcurrentLocation();
            moveMap();
            //calculateDistance(latitude,longitude,48.10484633841309, -1.7143872754268354);
            // calculateDistance(latitude,longitude,47.21849978208767, -1.5393824871074253);
